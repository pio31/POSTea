              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // to implement the cart add/remove features
                    Align(
...
Widget card({Color primaryColor = Colors.redAccent, String imgPath}) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: <BoxShadow>[
        BoxShadow(offset: Offset(0, 5), blurRadius: 10.0, color: Colors.grey[300]),
      ]
    ),
    child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(20.0)),
...
addItemToCart(String shortInfoAsId , BuildContext context)
{
   ...
   EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
      ...
      .updateData({
        ...
        Fluttertoast.showToast(msg: "Food added to cart Successfully");
