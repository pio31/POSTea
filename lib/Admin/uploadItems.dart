...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  Widget build(BuildContext context) {
    return file == null ? displayAdminHomeScreen() : displayAdminUploadFormHomeScreen();
  }
  ...
  takeImage(mContext)
  {
    return showDialog(
      ...
      {
        return SimpleDialog(
          title: Text("Item Image", style: TextStyle(color: Colors.orangeAccent,fontWeight: FontWeight.bold),),
          children: [
            SimpleDialogOption(
              child: Text("Capture with Camera", style: TextStyle(color: Colors.blueGrey,)),
              onPressed: capturePhotoWithCamera,
            ),
            SimpleDialogOption(
              child: Text("Select From Gallery", style: TextStyle(color: Colors.blueGrey,)),
  ...
  pickPhotoFromGallery() async
  {
    ...
    displayAdminUploadFormHomeScreen()
  {
    return Scaffold(
      appBar: AppBar(
        flexibleSpace: Container(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading: Icon(Icons.perm_device_information, color: Colors.blueGrey,),
            title: Container(
              width: 250.0,
              child: TextField(
